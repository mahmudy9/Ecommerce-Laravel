...
@foreach ($products as $product)
  ...
  <div class="card-body">
    ...
    <button onclick="approve_product( '{{$product->id}}' ,'{{url('admin/approve-product/')}}' )" class="btn btn-info">Approve Product</button><hr>
    <button onclick="seen( '{{$product->id}}' ,'{{url('admin/seen/')}}' )" class="btn btn-success">Seen Product</button><hr>
